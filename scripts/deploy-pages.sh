...
echo "   🍗 快樂鹽酥雞官網   https://chui-happy-chicken.pages.dev"
echo "   👄 嘴付公版入口     https://chui-portal.pages.dev（點「好喝奶茶店」進店）"
echo ""
echo "下一步：把 apps/hub/merchants.json 裡 happy-chicken 的 web_url 改成"
echo "        https://chui-happy-chicken.pages.dev 後重啟 Hub（公版入口的"
echo "        「前往官網」連結會用到）。"
